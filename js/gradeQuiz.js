$(document).ready(function(){
    ...
    $("form").submit(function(event) {
        ...
        $("#waiting").html("<img src='img/loading.gif' >")
        ...
        $("#question3-feedback").append("The answer is <strong>Siberian Husky</strong>");
        ...
        $("#question4-feedback").append("The answer is <strong>Pembroke Welsh Corgi</strong>");
